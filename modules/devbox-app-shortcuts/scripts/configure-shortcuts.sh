...
declare -A shortcuts=(
  ...
  [devbox-winbox-toggle.desktop]=Meta+Alt+W
...
declare -A key_codes=(
  ...
  [devbox-winbox-toggle.desktop]=402653271 # Meta+Alt+W
...
echo "[devbox-app-shortcuts] Installed Meta+0/1/2/3/6/7/9/X/P and Meta+Alt+W bindings"

            ...
            RowLayout {
                ...
                Rectangle {
                    ...
                    TextInput {
                        ...
                        onAccepted: sddm.login(avatarRect.displayUser, passwordBox.text, sessionModel.lastIndex)
                        Keys.onPressed: {
                            if (event.key === Qt.Key_Return || event.key === Qt.Key_Enter) {
                                sddm.login(avatarRect.displayUser, passwordBox.text, sessionModel.lastIndex)
                                event.accepted = true
                            }
                        }
                    }
                ...
                Controls.Button {
                    ...
                    onClicked: sddm.login(avatarRect.displayUser, passwordBox.text, sessionModel.lastIndex)
                }
            }
